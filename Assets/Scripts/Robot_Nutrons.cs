...
public class Robot_Nutrons : RobotInterface3D
{
  ...
  public Robot_Nutrons.PullyData[] inertia_shooter_pulleys;
  ...
  private Robot_Nutrons.intakeStates intake_statemachine;
  private Robot_Nutrons.intakeStates old_intake_statemachine;
  ...
  public override void RobotFixedUpdate()
  {
    ...
    float num3 = Vector2.SignedAngle(vector2_2 - vector2_1, vector2_4 - vector2_1) + this.turret_angle_correction;
    this.delta_angle_display = (double) num3;
  ...
  public override void Update_Robot()
  {
    ...
    {
      if (this.gamepad1_y)
        this.intake_statemachine = Robot_Nutrons.intakeStates.reverse;
      else if (this.intake_statemachine == Robot_Nutrons.intakeStates.reverse)
        this.intake_statemachine = Robot_Nutrons.intakeStates.onNormal;
      if (this.gamepad1_a && !this.a_button_last)
        this.intake_statemachine = this.intake_statemachine != Robot_Nutrons.intakeStates.onNormal ? Robot_Nutrons.intakeStates.onNormal : Robot_Nutrons.intakeStates.off;
      this.a_button_last = this.gamepad1_a;
      if (this.intake_statemachine != this.old_intake_statemachine)
      {
        if (this.intake_statemachine == Robot_Nutrons.intakeStates.off)
        {
          if ((bool) (UnityEngine.Object) this.sound_controller)
            this.sound_controller.revdown();
        }
        else if (this.old_intake_statemachine == Robot_Nutrons.intakeStates.off && (bool) (UnityEngine.Object) this.sound_controller)
      ...
      {
        if ((bool) (UnityEngine.Object) this.audio_manager && this.audio_manager.IsSoundStarted("hangerraise"))
      ...
      else if ((bool) (UnityEngine.Object) this.audio_manager && this.audio_manager.IsSoundStarted("adjustangle"))
      ...
      else
      {
        ...
        float num2 = 0.0f;
        if (this.intake_statemachine == Robot_Nutrons.intakeStates.reverse)
      ...
      if (this.intake_statemachine == Robot_Nutrons.intakeStates.onNormal)
      {
  ...
  {
    foreach (Robot_Nutrons.PullyData inertiaShooterPulley in this.inertia_shooter_pulleys)
    {
  ...
  private void Inertia_SpinUpFlywheel() => this.inertia_shooter_flywheel.motor = this.inertia_shooter_flywheel.motor with
  {
    force = 0.5f,
    targetVelocity = -900f,
    freeSpin = true
  ...
  private void Inertia_StopFlywheel() => this.inertia_shooter_flywheel.motor = this.inertia_shooter_flywheel.motor with
  {
    force = 0.0f,
    targetVelocity = -900f,
    freeSpin = true
  ...
  public override void SetStates(string instring)
  {
    ...
    if (strArray.Length <= 1)
      return;
    this.intake_statemachine = (Robot_Nutrons.intakeStates) int.Parse(strArray[1]);
  }
