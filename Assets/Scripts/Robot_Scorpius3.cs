...
public class Robot_Scorpius3 : RobotInterface3D
{
  ...
  private Robot_Scorpius3.Collector_States collector_state;
  private Robot_Scorpius3.Delivery_States auto_mode;
  ...
  public override void Update_Robot()
  {
    ...
    {
      case Robot_Scorpius3.Delivery_States.raising_arm:
        ...
        {
          this.auto_mode = Robot_Scorpius3.Delivery_States.rotating_bucket;
          break;
        }
        break;
      case Robot_Scorpius3.Delivery_States.rotating_bucket:
        if ((double) this.Bucket.targetRotation.x == (double) this.bucket_deposit_pos)
        {
          this.auto_mode = Robot_Scorpius3.Delivery_States.waiting;
          this.time_wait_start = MyUtils.GetTimeMillis();
          break;
        }
        break;
      case Robot_Scorpius3.Delivery_States.waiting:
        if (MyUtils.GetTimeMillis() - this.time_wait_start > this.auto_dumping_wait)
        {
          this.auto_mode = Robot_Scorpius3.Delivery_States.lowering_arm;
          break;
        }
        break;
      case Robot_Scorpius3.Delivery_States.lowering_arm:
        if ((double) Math.Abs(this.lift_arm2.targetPosition.x) < 0.00999999977648258)
        {
          this.auto_mode = Robot_Scorpius3.Delivery_States.off;
          break;
        }
        break;
    }
    ...
    if (this.gamepad1_dpad_down || this.auto_mode == Robot_Scorpius3.Delivery_States.lowering_arm)
    {
    ...
    if (this.gamepad1_dpad_up || this.auto_mode == Robot_Scorpius3.Delivery_States.raising_arm)
    {
    ...
    if (this.gamepad1_x || this.auto_mode == Robot_Scorpius3.Delivery_States.rotating_bucket)
      this.Bucket.targetRotation = this.Bucket.targetRotation with
      {
    ...
    if (this.gamepad1_b)
    {
      if (!this.gamepad_b_previous)
        this.collector_state = this.collector_state == Robot_Scorpius3.Collector_States.off ? Robot_Scorpius3.Collector_States.reverse : Robot_Scorpius3.Collector_States.off;
    ...
    if (this.gamepad1_a)
    {
      if (!this.gamepad_a_previous)
        this.collector_state = this.collector_state == Robot_Scorpius3.Collector_States.off ? Robot_Scorpius3.Collector_States.on : Robot_Scorpius3.Collector_States.off;
    ...
    {
      case Robot_Scorpius3.Collector_States.on:
        num1 = this.collector_speed;
        break;
      case Robot_Scorpius3.Collector_States.reverse:
        num1 = -this.collector_speed;
        break;
    }
    ...
    if (this.gamepad1_y)
    {
      if (!this.gamepad_y_previous)
        this.auto_mode = this.auto_mode == Robot_Scorpius3.Delivery_States.off ? Robot_Scorpius3.Delivery_States.raising_arm : Robot_Scorpius3.Delivery_States.off;
      this.gamepad_y_previous = true;
    }
    else
      this.gamepad_y_previous = false;
    if (this.auto_mode == Robot_Scorpius3.Delivery_States.raising_arm || this.auto_mode == Robot_Scorpius3.Delivery_States.rotating_bucket || this.auto_mode == Robot_Scorpius3.Delivery_States.waiting)
    {
