...
public class Robot_Roboteers : RobotInterface3D
{
  ...
  public Robot_Roboteers.PullyData[] inertia_shooter_pulleys;
  ...
  private Robot_Roboteers.intakeStates intake_statemachine;
  private Robot_Roboteers.intakeStates old_intake_statemachine;
  ...
  public override void Update_Robot()
  {
    ...
    {
      if (this.gamepad1_y)
        this.intake_statemachine = Robot_Roboteers.intakeStates.reverse;
      else if (this.intake_statemachine == Robot_Roboteers.intakeStates.reverse)
        this.intake_statemachine = Robot_Roboteers.intakeStates.onNormal;
      if (this.gamepad1_a && !this.a_button_last)
        this.intake_statemachine = this.intake_statemachine != Robot_Roboteers.intakeStates.onNormal ? Robot_Roboteers.intakeStates.onNormal : Robot_Roboteers.intakeStates.off;
      this.a_button_last = this.gamepad1_a;
      if (this.intake_statemachine != this.old_intake_statemachine)
      {
        if (this.intake_statemachine == Robot_Roboteers.intakeStates.off)
        {
          if ((bool) (UnityEngine.Object) this.sound_controller)
            this.sound_controller.revdown();
        }
        else if (this.old_intake_statemachine == Robot_Roboteers.intakeStates.off && (bool) (UnityEngine.Object) this.sound_controller)
      ...
      else
      {
        ...
        float num2 = 0.0f;
        if (this.intake_statemachine == Robot_Roboteers.intakeStates.reverse)
      ...
      if (this.intake_statemachine == Robot_Roboteers.intakeStates.onNormal)
      {
  ...
  public override void SetStates(string instring)
  {
    ...
    if (strArray.Length <= 1)
      return;
    this.intake_statemachine = (Robot_Roboteers.intakeStates) int.Parse(strArray[1]);
  }
