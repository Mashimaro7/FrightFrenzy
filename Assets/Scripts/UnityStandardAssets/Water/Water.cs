...
namespace UnityStandardAssets.Water
{
  ...
  public class Water : MonoBehaviour
  {
    ...
    public void OnWillRenderObject()
    {
      ...
      switch (waterMode)
      {
        case UnityStandardAssets.Water.Water.WaterMode.Simple:
          Shader.EnableKeyword("WATER_SIMPLE");
          Shader.DisableKeyword("WATER_REFLECTIVE");
          Shader.DisableKeyword("WATER_REFRACTIVE");
          break;
        case UnityStandardAssets.Water.Water.WaterMode.Reflective:
          Shader.DisableKeyword("WATER_SIMPLE");
          Shader.EnableKeyword("WATER_REFLECTIVE");
          Shader.DisableKeyword("WATER_REFRACTIVE");
          break;
        case UnityStandardAssets.Water.Water.WaterMode.Refractive:
          Shader.DisableKeyword("WATER_SIMPLE");
          Shader.DisableKeyword("WATER_REFLECTIVE");
    ...
    private UnityStandardAssets.Water.Water.WaterMode GetWaterMode() => this.m_HardwareWaterSupport < this.waterMode ? this.m_HardwareWaterSupport : this.waterMode;
